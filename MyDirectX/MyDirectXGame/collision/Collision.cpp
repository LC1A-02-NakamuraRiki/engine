...
bool Collision::CheckRay2Triangle(const Ray &ray, const Triangle &triangle, float *distance, DirectX::XMVECTOR *inter)
{
	...
	m2 = XMVector3Cross(pt_p1, p0_p2);
	if (XMVector3Dot(m2, triangle.normal).m128_f32[1] < -epsilon) { return false; }

	XMVECTOR m3;
	XMVECTOR pt_p2 = triangle.p2 - interPlane;
	XMVECTOR p0_p0 = triangle.p0 - triangle.p2;
	m3 = XMVector3Cross(pt_p2, p0_p0);
	if (XMVector3Dot(m3, triangle.normal).m128_f32[2] < -epsilon) { return false; }
